...
namespace ES3Internal
{
	public static class ES3Reflection
	{
		...
		{
			return Enumerable.ToList(Enumerable.Select(Enumerable.Where(Enumerable.SelectMany(Assemblies, (Assembly assembly) => assembly.GetTypes(), (Assembly assembly, Type type) => new { assembly, type }), _003C_003Eh__TransparentIdentifier0 => IsAssignableFrom(derivedType, _003C_003Eh__TransparentIdentifier0.type)), _003C_003Eh__TransparentIdentifier0 => _003C_003Eh__TransparentIdentifier0.type));
		}
		...
		{
			return Enumerable.ToArray(Enumerable.Where(type.GetMethods(), (MethodInfo t) => t.Name == methodName));
		}
