...
namespace ES3Internal
{
	...
	public abstract class ES3SerializableDictionary<TKey, TVal> : Dictionary<TKey, TVal>, ISerializationCallbackReceiver
	{
		...
		{
			List<TKey> list = Enumerable.ToList(Enumerable.Select(Enumerable.Where(this, (KeyValuePair<TKey, TVal> pair) => pair.Value == null), (KeyValuePair<TKey, TVal> pair) => pair.Key));
